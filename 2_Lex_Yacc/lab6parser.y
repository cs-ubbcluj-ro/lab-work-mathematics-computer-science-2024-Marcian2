...
%token <string> INCLUDE IOSTREAM USING NAMESPACE STD MAIN INT CIN COUT IF ELSE FOR BREAK ENDL IDENTIFIER CONSTANT
...
%%
program:
    { add_production(1); } // Add this line at the start
